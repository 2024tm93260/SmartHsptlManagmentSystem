...
const AdminDoctorCard = ({ doctor }) => {
  ...
  return (
    <Card className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 h-full flex flex-col bg-card">

      {/* Header */}
      <div className="relative admin-accent-gradient p-6 pb-12">
        <div className="absolute top-0 right-0 w-24 h-24 bg-card/10 rounded-full -mr-12 -mt-12"></div>
        <div className="absolute bottom-0 left-0 w-16 h-16 bg-card/10 rounded-full -ml-8 -mb-8"></div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          <Badge className="admin-accent-gradient text-primary-foreground hover:bg-primary/90 gap-1 shadow-md">
      ...
      <CardFooter className="p-4 pt-0">
        <Button
          ...
          className="w-full gap-2 admin-accent-gradient hover:opacity-90"
        >
          View Profile
