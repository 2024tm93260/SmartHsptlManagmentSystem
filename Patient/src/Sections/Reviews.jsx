  ...
  return (
    <section className="py-16 lg:py-24 bg-muted">
      <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-border">
                    <Avatar className="w-10 h-10">
                      <AvatarFallback className="patient-accent-gradient text-primary-foreground font-semibold text-sm">
        ...
        {/* Stats Bar */}
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 p-8 bg-card rounded-2xl shadow-md">
