  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[60vh] bg-muted">
        ...
        <p className="text-muted-foreground font-medium">Loading doctors...</p>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">{filteredDoctors?.length || 0}</span> {filteredDoctors?.length === 1 ? "doctor" : "doctors"} found
            </p>
          </div>
          {searchQuery && (
