  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[60vh] bg-muted">
        ...
        <p className="text-muted-foreground font-medium">Loading prescription details...</p>
      </div>
    );
  }
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-primary/5 rounded-lg">
                <p className="text-foreground font-medium">{diagonosis || "No diagnosis provided"}</p>
              </div>
            </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="grid md:grid-cols-2 gap-3 ml-6">
                            ...
                            <div>
                              ...
                              <p className="text-foreground font-medium">{medicine.frequency}</p>
                            </div>
                            <div>
                              <p className="text-sm text-muted-foreground mb-1">Duration</p>
                              <p className="text-foreground font-medium">{medicine.duration}</p>
                            </div>
                          </div>
                        </div>
                      </CardContent>
