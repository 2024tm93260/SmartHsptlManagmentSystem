...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (res.meta.requestStatus === "fulfilled") {
        toast.success("Registration successful! Welcome to BIMS");
        navigate("/login");
      } else {
  ...
  return (
    ...
    <div className="min-h-screen patient-page-gradient py-12 px-4">
      <div className="container mx-auto max-w-5xl">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-12 h-12 patient-accent-gradient rounded-lg flex items-center justify-center shadow-lg">
              ...
              <div className="flex flex-col items-center space-y-4 pb-6 border-b">
                <div className="relative">
                  ...
                  <label 
                    ...
                    className="absolute bottom-0 right-0 w-8 h-8 bg-primary hover:bg-primary/90 rounded-full flex items-center justify-center cursor-pointer shadow-lg transition-colors"
                  >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="guardianName" className="flex items-center gap-2">
                    <User className="w-4 h-4 text-muted-foreground" />
                    Guardian Name <span className="text-muted-foreground text-xs">(Optional)</span>
                  </Label>
                  <Input
                    id="guardianName"
