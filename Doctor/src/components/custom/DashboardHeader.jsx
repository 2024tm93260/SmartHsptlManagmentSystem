...
const DashboardHeader = ({ profile, isAuthenticated }) => {
  ...
  return (
    <div className="doctor-accent-gradient text-white shadow-lg">
      <div className="container mx-auto px-4 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-primary-foreground text-sm mb-1">{getGreeting()},</p>
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-primary-foreground text-xs mb-1">Today's Date</p>
