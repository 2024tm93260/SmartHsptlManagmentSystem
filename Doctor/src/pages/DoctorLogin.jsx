...
const DoctorLogin = () => {
  ...
  return (
    <div className="min-h-screen doctor-page-gradient flex items-center justify-center p-4">
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 text-base font-medium doctor-accent-gradient hover:opacity-90"
              >
                {loading ? (
                  <>
