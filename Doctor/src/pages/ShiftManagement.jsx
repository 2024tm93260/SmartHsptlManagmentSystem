    ...
    <Card className="border-0 shadow-lg">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="p-4 bg-muted rounded-lg space-y-4">
          <p className="font-semibold text-foreground">Add New Schedule</p>
        ...
        {shifts.length > 0 && (
          <div className="space-y-3">
            <p className="font-semibold text-foreground">Current Schedule ({shifts.length})</p>
            {shifts.map((shift, index) => (
              <div 
                key={index} 
                className="flex items-center justify-between p-4 bg-white border border-border rounded-lg hover:border-border transition-colors"
              >
