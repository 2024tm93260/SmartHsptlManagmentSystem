    ...
    <div className="min-h-screen doctor-page-gradient py-12">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
        ...
        <Button
          ...
          className="mb-6 gap-2 text-primary hover:text-foreground"
        >
          ...
          <CardContent className="space-y-10 py-6">
            ...
            <section className="space-y-3">
              ...
              {fields.map((field, index) => (
                <div
                  key={field.id}
                  className="p-4 bg-white rounded-xl shadow border border-border space-y-4"
                >
            ...
            <Button
              ...
              className="w-full bg-primary hover:bg-secondary text-white py-6 text-lg gap-2"
            >
