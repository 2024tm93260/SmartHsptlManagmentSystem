                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="w-full space-y-3">
                      <input
                        ...
                        className="block w-full text-sm text-muted-foreground file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-muted file:text-primary hover:file:bg-muted"
                      />
                      {profilePicFile && (
                        <Button
                          type="button"
                          ...
                          disabled={loading}
                          className="w-full gap-2 doctor-accent-gradient"
                        >
                          {loading ? (
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            ...
                            <SelectContent className="bg-white">
                              <SelectItem value="Cardiology" className="hover:bg-muted">Cardiology</SelectItem>
                              <SelectItem value="Neurology" className="hover:bg-muted">Neurology</SelectItem>
                              <SelectItem value="Orthopedics" className="hover:bg-muted">Orthopedics</SelectItem>
                              <SelectItem value="Pediatrics" className="hover:bg-muted">Pediatrics</SelectItem>
                              <SelectItem value="Dermatology" className="hover:bg-muted">Dermatology</SelectItem>
                              <SelectItem value="General" className="hover:bg-muted">General Medicine</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
