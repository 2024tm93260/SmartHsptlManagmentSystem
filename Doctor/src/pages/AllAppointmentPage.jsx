...
const AllAppointmentsPage = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen doctor-page-gradient">
  ...
  return (
    <div className="min-h-screen doctor-page-gradient py-8">
            ...
            {data?.map((appointment, index) => {
              ...
              return (
                <div key={appointment._id}>
                  <div className="flex items-center justify-between p-4 bg-muted rounded-lg hover:bg-muted transition-colors">
