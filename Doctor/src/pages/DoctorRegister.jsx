...
const DoctorRegister = () => {
  ...
  return (
    <div className="min-h-screen doctor-page-gradient py-12 px-4">
      <div className="container mx-auto max-w-4xl">

        {/* Header */}
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-12 h-12 doctor-accent-gradient rounded-lg flex items-center justify-center shadow-lg">
              <Stethoscope className="w-7 h-7 text-white" />
            </div>
            <h1 className="text-3xl font-bold text-foreground">BIMS</h1>
          </div>
          <p className="text-muted-foreground">Register as a Medical Professional</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(v) => setValue("sex", v)}>
                    ...
                    <SelectContent>
                      <SelectItem value="Male" className="hover:bg-muted">Male</SelectItem>
                      <SelectItem value="Female" className="hover:bg-muted">Female</SelectItem>
                ...
                {/* Department */}
                <div className="space-y-2"> <Label htmlFor="department"> <Building2 className="w-4 h-4 text-muted-foreground inline mr-2" /> Department * </Label> <Select onValueChange={(value) => setValue("department", value)}> <SelectTrigger className="bg-white border-border"> <SelectValue placeholder="Select department" /> </SelectTrigger> <SelectContent className="bg-white">
                  <SelectItem value="General Medicine" className="hover:bg-muted">General Medicine</SelectItem>
                  <SelectItem value="Cardiology" className="hover:bg-muted">Cardiology</SelectItem> <SelectItem value="Neurology" className="hover:bg-muted">Neurology</SelectItem> <SelectItem value="Orthopedics" className="hover:bg-muted">Orthopedics</SelectItem> <SelectItem value="Pediatrics" className="hover:bg-muted">Pediatrics</SelectItem> <SelectItem value="Dermatology" className="hover:bg-muted">Dermatology</SelectItem> <SelectItem value="Gynecology" className="hover:bg-muted">Gynecology</SelectItem>
                  <SelectItem value="Ophthalmology" className="hover:bg-muted">Ophthalmology</SelectItem>
                  <SelectItem value="ENT" className="hover:bg-muted">ENT</SelectItem>
                  <SelectItem value="Psychiatry" className="hover:bg-muted">Psychiatry</SelectItem>
                  <SelectItem value="Gastroenterology" className="hover:bg-muted">Gastroenterology</SelectItem>
                  <SelectItem value="Urology" className="hover:bg-muted">Urology</SelectItem>
                  <SelectItem value="Pulmonology" className="hover:bg-muted">Pulmonology</SelectItem>
                </SelectContent>
                </Select>
                  <input type="hidden"
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 doctor-accent-gradient text-white"
              >
                {loading ? (
                  <>
